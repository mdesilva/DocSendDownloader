...
let initiateDownload = (url) => {
    const filename = document.getElementsByClassName("contact-card_email").length == 1 ? document.getElementsByClassName("contact-card_email")[0].href.split("@")[1].split(".")[0] : "slidedeck";
